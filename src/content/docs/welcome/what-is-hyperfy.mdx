...
Hyperfy is a virtual world-builder engine where anyone can create and explore.

These are accessible from any web browser on any device, including virtual reality.

They can also be collaboratively edited in real-time and do not require technical skills\* to combine apps to create interoperable and immersive experience.
