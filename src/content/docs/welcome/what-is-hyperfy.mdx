...
Hyperfy is an open source game-engine expanding on the power of browser-based Threejs and PhysX.

Collaboratively build virtual worlds, 3d games, immersive experiences, and the open-interoperable metaverse.

Accessible on any device, including virtual reality, Hyperfy's mission is to make spatial environments and the bridge between them available for everyone.

In addition to the current v2 game-engine in development, Hyperfy is launching a marketplace and platform empowering all to join the movement.
...
<small>
  {""} Note: The Hyperfy engine is in beta and there are a limited number of
  Core and Block apps currently available.
</small>
...
<LinkCard title="For Developer Quick Start 👩‍💻🚀" href="/setup/quickstart" />
<LinkCard
  title="For Detailed Step-by-Step Instructions 🔍🎯"
  href="/setup/detailed"
/>
...
<CardGrid>
  <LinkCard
    title="Revisit the 90's nostalgia - 📼 Blockbuster by Roustan"
    href="https://hyperfy.io/blockbuster"
  />
...
<CardGrid>
  <LinkCard
    title="Video Walkthrough - @beb.eth 🛠 | RTFKT"
    href="/community/videos#Hyperfy"
  />
  <LinkCard
    title="Hyperfy Historical Walkthrough"
    href="https://hackmd.io/@metamike/hyperfy"
  />
</CardGrid>
